import numpy as np
from .basic_operations_robnet import *

""" copied from https://github.com/gmh14/RobNets/blob/master/models/basic_model.py """
...
class RobNet(nn.Module):
    ...
    def __init__(self, C=36, num_classes=10, layers=20, steps=4, multiplier=4, stem_multiplier=3,
        ...
        # We fixed the network as robnet_large_v2
        genotype_list = [['11', '11',
                                      '11', '11',
                                      '11', '01',
                                      '11', '01',
